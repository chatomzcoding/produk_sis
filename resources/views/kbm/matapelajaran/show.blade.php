                  ...
                  <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                      ...
                      <ul class="list-group list-group-unbordered mb-3">
                        ...
                        <li class="list-group-item">
                          <b>Jumlah Siswa</b> <a class="float-right">543</a>
                        </li>
                      </ul>
                    </div>
                    <!-- /.card-body -->
                      ...
                      <div class="tab-content">
                        <div class="active tab-pane" id="activity">
                            <table class="table table-borderless">
                                ...
                                @foreach ($matapelajaran->jadwalpelajaran->jadwalkelas as $key)
                                    <tr>
                                        <td>{{ $key->hari }}</td>
                                        <td>{{ $key->jam }}</td>
                        ...
                        <div class="tab-pane" id="timeline">
                            ...
                            <section>
                                <table class="table table-borderless">
                                    ...
                                    @foreach ($matapelajaran->ujian as $key)
                                        <tr>
                                            ...
                                            <td>
                                                @if (count($key->soal) > 0)
                                                    <a href="{{ url('ujian/'.$key->id) }}" class="btn btn-info btn-sm">lihat soal</a>
                                                @else
                                                    <a href="{{ url('soal/create?id='.$key->id) }}" class="btn btn-primary btn-sm">Buat Soal</a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <form action="{{ url('ujian')}}" method="post">
                    @csrf
                    <input type="hidden" name="matapelajaran_id" value="{{ $matapelajaran->id }}">
