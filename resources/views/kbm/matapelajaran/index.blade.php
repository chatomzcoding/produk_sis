                            ...
                            <tbody class="text-capitalize">
                                ...
                                <tr>
                                        ...
                                        <td class="text-center">
                                            <form id="data-{{ $item->id }}" action="{{url('matapelajaran'.'/'.$item->id)}}" method="post">
                                                @csrf
                                                @method('delete')
                                                </form>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <button type="button" data-toggle="modal" data-nama_pelajaran="{{ $item->nama_pelajaran }}"  data-id="{{ $item->id }}" data-target="#ubah" title="" class="dropdown-item" data-original-title="Edit Data"><i class="fa fa-edit text-success" style="width: 25px"> </i> EDIT
                                                        </button>
                                                      <div class="dropdown-divider"></div>
    ...
    <x-slot name="kodejs">
        <script>
            $('#ubah').on('show.bs.modal', function (event) {
                ...
                var nama_pelajaran = button.data('nama_pelajaran')
                var id = button.data('id')
        
                var modal = $(this)
        
                modal.find('.modal-body #nama_pelajaran').val(nama_pelajaran);
